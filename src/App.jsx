...
function AppContent() {
    ...
    useEffect(() => {
        const initializeApp = async () => {
            ...
            const hasOrderSuccess = params.has('orderSuccess') || hashParams.has('orderSuccess') || params.has('replenishmentSuccess') || hashParams.has('replenishmentSuccess');
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            {/* Main Content */}
            <main className={`flex-1 overflow-y-auto ${['liffOrder', 'pos'].includes(page) ? '' : 'p-4 md:p-6'} ${isHeaderForcedHidden ? '-mt-[76px]' : 'mt-0'} transition-all duration-300`}>
