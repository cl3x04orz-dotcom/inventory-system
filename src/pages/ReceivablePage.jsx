            ...
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
                        <Wallet className="text-emerald-600" /> 應收帳款 (Receivables)
                    </h1>
                </div>
                <div className="glass-panel px-4 py-2 border-emerald-200 bg-emerald-50">
                    <p className="text-xs text-slate-500">總應收金額</p>
