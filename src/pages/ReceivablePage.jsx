            ...
            <div className="mb-6 p-4 rounded-xl bg-[var(--bg-secondary)] border border-[var(--border-primary)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="space-y-1">
                        ...
                        <input type="date" className="input-field w-full h-10 appearance-none bg-[var(--bg-primary)]" value={startDate} onChange={(e) => { setStartDate(e.target.value); setActiveQuickDate(''); }} />
                    </div>
                    <div className="space-y-1">
                        <label className="text-[10px] text-[var(--text-secondary)] font-bold uppercase px-1">結束日期</label>
                        <input type="date" className="input-field w-full h-10 appearance-none bg-[var(--bg-primary)]" value={endDate} onChange={(e) => { setEndDate(e.target.value); setActiveQuickDate(''); }} />
                    </div>
                    <div className="space-y-1">
