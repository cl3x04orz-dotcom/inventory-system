                                                        ...
                                                        {product.posSettings?.isActive !== false && (
                                                            <>
                                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                                    ...
                                                                    {/* 滿件特惠 */}
                                                                    <div className="flex flex-col h-full justify-between gap-2.5 bg-[var(--bg-tertiary)]/50 p-3.5 rounded-xl border border-[var(--border-primary)] hover:border-indigo-500/30 transition-colors">
                                                                        <div className="flex flex-col gap-2">
                                                                            <div className="flex justify-between items-center">
