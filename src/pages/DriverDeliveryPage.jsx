        ...
        <div className="min-h-screen bg-slate-100 text-slate-900 pb-16 font-sans">
            ...
            <div className="bg-emerald-50/80 border-b border-emerald-200 px-4 py-2.5 flex items-center justify-between gap-2 shadow-2xs">
                ...
                <button
                    ...
                    className={`text-[11px] font-bold px-2.5 py-1 rounded-lg border transition-all ${filterByDateStrict
            ...
            <div className="bg-white p-2 border-b border-slate-200 flex gap-2 shadow-xs">
                <button
                    ...
                    className={`flex-1 py-3 px-3 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all active:scale-98 ${activeTab === 'pack'
                ...
                <button
                    ...
                    className={`flex-1 py-3 px-3 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all active:scale-98 ${activeTab === 'deliver'
                                ...
                                <div className="space-y-3">
                                    ...
                                    {buildingTasks.map((task, idx) => {
                                        ...
                                        return (
                                            <div
                                                key={idx}
                                                className={`rounded-2xl border transition-all duration-200 p-4 space-y-3 ${isPacked
                                            ...
                                            >
                                                <div className="flex items-start justify-between gap-3">
                                                    ...
                                                    {task.orders.length > 1 ? (
                                                        <span className={`py-1.5 px-3 rounded-xl font-black text-xs flex items-center gap-1 border ${task.orders.every(o => isOrderPacked(o, task.buildingName))
                                                        ...
                                                        <button
                                                            ...
                                                            className={`py-2 px-3.5 rounded-xl font-black text-xs flex items-center gap-1.5 transition-all active:scale-95 shadow-xs ${isPacked
                                                                            ...
                                                                            <div className="flex items-center gap-2">
                                                                                ...
                                                                                {task.orders.length > 1 && (
                                                                                    <button
                                                                                        ...
                                                                                        className={`py-1.5 px-3 rounded-lg font-black text-xs flex items-center gap-1 transition-all active:scale-95 shadow-2xs ${orderPacked
                                                                                                ? 'bg-emerald-600 text-white shadow-emerald-600/30'
                                ...
                                <div className="space-y-3">
                                    ...
                                    {buildingTasks.map((task, idx) => {
                                        ...
                                        return (
                                            <div
                                                key={idx}
                                                className={`rounded-2xl border p-4 space-y-3 transition-all ${isDone
                                            ...
                                            >
                                                ...
                                                <div className="flex items-start justify-between border-b border-slate-100 pb-3">
                                                    <div>
                                                        <div className="flex items-center gap-2">
                                                            <span className={`w-6 h-6 rounded-full text-xs font-black flex items-center justify-center font-mono ${isDone ? 'bg-slate-200 text-slate-600' : 'bg-blue-600 text-white'
                                                                }`}>
                                                                {idx + 1}
                                                            </span>
                                                    ...
                                                    <span className={`text-xs px-2.5 py-1 rounded-full font-black border ${isDone
                                                            ? 'bg-emerald-100 text-emerald-800 border-emerald-300'
                                                ...
                                                {!isDone && (
                                                    <div className="bg-slate-50 rounded-xl p-3.5 border border-slate-200 space-y-3">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`w-full py-3.5 rounded-xl font-black text-sm flex items-center justify-center gap-2 shadow-md transition-all active:scale-95 ${hasPhoto && !isSubmitting
