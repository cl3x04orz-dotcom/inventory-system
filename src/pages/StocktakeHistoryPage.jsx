...
export default function StocktakeHistoryPage({ user, apiUrl }) {
    ...
    }, [user.token, apiUrl, startDate, endDate, diffOnly]);
        ...
        <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex gap-4">
                    <div className="glass-panel px-4 py-2 border-blue-500/20 bg-blue-500/5">
                        <p className="text-xs text-slate-400">總記錄</p>
                        <p className="text-xl font-bold text-white">{totalRecords}</p>
                    </div>
                    <div className="glass-panel px-4 py-2 border-red-500/20 bg-red-500/5">
                        <p className="text-xs text-slate-400">有差異</p>
                        <p className="text-xl font-bold text-red-400">{withDiff}</p>
                    </div>
                    <div className="glass-panel px-4 py-2 border-green-500/20 bg-green-500/5">
                        <p className="text-xs text-slate-400">無差異</p>
                        <p className="text-xl font-bold text-green-400">{noDiff}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="glass-panel p-4 space-y-4">
                <div className="flex flex-col md:flex-row gap-4 items-end">
                    ...
                    <label className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-800 border border-white/5 cursor-pointer hover:bg-slate-700 transition-colors">
                        <input
                            type="checkbox"
                            checked={diffOnly}
