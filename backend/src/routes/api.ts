...
const publicActions = ['getStoreSetting', 'login', 'register', 'checkInit', 'loginAdminByPassword', 'v2_getLiffInitData', 'v2_createOrder', 'v1_getMember', 'v1_saveMember', 'v1_getOrders', 'v1_reorder', 'getProductStock', 'getRewardConfig', 'getPrintTemplateConfig', 'savePrintTemplateConfig', 'getWebPushPublicKey', 'submitDriverDelivery'];
